...
1. Seleccionar una fecha para la cual se calcularán los precios estimados (Ver Imágen siguiente(fig:img4)).

```{r , echo=FALSE,label=img4}
knitr::include_graphics("images/ns1.png")
``` 

2. Selecionar los instrumentos a considerar ya sean TIF ó VEBONO (Ver Imágen siguiente(fig:img5)), para este fin el usuario podrá elegir los mismos selecionando su nombre corto o ingresando un archivo plano (Ver Imágen siguiente(fig:img6)). Cabe destacar que este archivo debera tener las siguientes características,
...
```{r , echo=FALSE, label=img5}
knitr::include_graphics("images/ns2.png")
``` 
```{r , echo=FALSE, label=img6}
knitr::include_graphics("images/ns1.1.png")
``` 


3. El usuario debera seleccionar un método para calcular los precios teóricos, los cuales se ubican en estas secciones (Ver Imágen siguiente(fig:img7)),
...
```{r , echo=FALSE,label=img7}
knitr::include_graphics("images/ns3.png")
``` 
```{r , echo=FALSE,label=img8}
...
```{r , echo=FALSE, label=img11}
knitr::include_graphics("images/ns7.png")
``` 
```{r , echo=FALSE, label=img12}
...
1. Seleccionar una fecha para la cual se calcularán los precios estimados (Ver Imágen siguiente(fig:img13)).
```{r , echo=FALSE, label=img13}
knitr::include_graphics("images/sv1.png")
``` 

2. Selecionar los instrumentos a considerar ya sean TIF ó VEBONO, para este fin el usuario podrá elegir los mismos selecionando su nombre corto o ingresando una archivo plano (Ver Imágens siguiente(fig:img5) y siguiente(fig:img6)). Cabe destacar que este archivo debera tener las siguientes características,
    + Debe ser un archivo plano (txt).
    + Debe contener una columna, la cual debe ser del tipo caracter donde se indicará el nombre corto del instrumento a considerar.
    + Ejemplo estructura fila: Para el TIF cuyo vencimiento es el "02/08/2019". En este caso el nombre corto de este instrumento es "TIF082019". Así para cada fila debe existir la siguiente información "TIF082019".
    + El archivo debe contener tantas filas como instrumentos desee considerar el usuario. Posteriormente se mostraran los títulos seleccionados por el usuario así como su respectivo precio promedio es caso de existir, de lo contrario el precio asignado será de 0. Se mostrará también el documento de las características de los instrumentos financieros venezolanos, con el fin de que el usuario pueda observar en detalle cada instrumento.
...
```{r , echo=FALSE, label=img14}
knitr::include_graphics("images/sv3.png")
``` 
```{r , echo=FALSE, label=img15}
...
```{r , echo=FALSE, label=img17}
knitr::include_graphics("images/sv7.png")
``` 
```{r , echo=FALSE, label=img18}
...
1. Seleccionar una fecha para la cual se calcularán los precios estimados (Ver Imágen siguiente(fig:img19)).
...
```{r , echo=FALSE, label=img20}
knitr::include_graphics("images/dl2.png")
``` 
4. Una vez visualizada la curva ajustada mediante el spline, es necesario calibrar el parámetro de suavizamiento, el mismo controla la suavidad de la curva mostrada (Ver Imágen siguiente(fig:img21)).
```{r , echo=FALSE}
knitr::include_graphics("images/dl3.1.png")
``` 
```{r , echo=FALSE, label=img21}
knitr::include_graphics("images/dl3.png")
``` 
5. Luego de seleccionar este valor, se mostrará el spline a utilizar en el cálculo de los precios teóricos (Ver Imágen siguiente(fig:img22)). Posteriormente se mostrarán los precios estimados y la curva de rendimientos obtenida, la cual en este caso es una superficie (Ver Imágen siguiente(fig:img23)). Esto debido a considerar los parámetros de Diebold-Li dinámicos con respecto al tiempo.
```{r , echo=FALSE, label=img22}
knitr::include_graphics("images/dl4.png")
``` 
```{r , echo=FALSE, label=img23}
...
1. Seleccionar una fecha para la cual se calcularán los precios estimados (Ver Imágen siguiente(fig:img24)).
2. Selecionar los instrumentos a considerar ya sean TIF ó VEBONO, para este fin el usuario podrá elegir los mismos selecionando su nombre corto o ingresando una archivo plano. Cabe destacar que este archivo debera tener las siguientes características,
    + Debe ser un archivo plano (txt).
    + Debe contener una columna, la cual debe ser del tipo caracter donde se indicará el nombre corto del instrumento a considerar.
    + Ejemplo estructura fila: Para el TIF cuyo vencimiento es el "02/08/2019". En este caso el nombre corto de este instrumento es "TIF082019". Así para cada fila debe existir la siguiente información "TIF082019".
    + El archivo debe contener tantas filas como instrumentos desee considerar el usuario. Posteriormente se mostraran los títulos seleccionados por el usuario así como su respectivo precio promedio es caso de existir, de lo contrario el precio asignado será de 0. Se mostrará también el documento de las características de los instrumentos financieros venezolanos, con el fin de que el usuario pueda observar en detalle cada instrumento.
```{r , echo=FALSE, label=img24}
...
```{r , echo=FALSE, label=img25}
knitr::include_graphics("images/sp2.png")
``` 
4.  Una vez visualizada la curva ajustada mediante el spline, es necesario calibrar el parámetro de suavizamiento, el mismo controla la suavidad de la curva mostrada (Ver Imágen siguiente(fig:img26)).
```{r , echo=FALSE, label=img26}
knitr::include_graphics("images/sp4.png")
``` 
5. A continuación se mostraran los títulos candidatos a partir de los cuales la curva de rendimientos será trazada (Ver Imágen siguiente(fig:img27)). Posteriormente se mostrarán los precios estimados y la curva de rendimientos obtenida (Ver Imágens siguiente(fig:img28) y siguiente(fig:img29)). 
```{r , echo=FALSE, label=img27}
knitr::include_graphics("images/sp3.png")
``` 
```{r , echo=FALSE, label=img28}
knitr::include_graphics("images/sp5.png")
``` 
```{r , echo=FALSE, label=img29}
...
1. Seleccionar una fecha para la cual se calcularán los precios estimados (Ver Imágen siguiente(fig:img34)).
2. Selecionar los instrumentos a considerar ya sean TIF ó VEBONO, para este fin el usuario podrá elegir los mismos selecionando su nombre corto o ingresando una archivo plano. Cabe destacar que este archivo debera tener las siguientes características,
    + Debe ser un archivo plano (txt).
    + Debe contener una columna, la cual debe ser del tipo caracter donde se indicará el nombre corto del instrumento a considerar.
    + Ejemplo estructura fila: Para el TIF cuyo vencimiento es el "02/08/2019". En este caso el nombre corto de este instrumento es "TIF082019". Así para cada fila debe existir la siguiente información "TIF082019".
    + El archivo debe contener tantas filas como instrumentos desee considerar el usuario. Posteriormente se mostraran los títulos seleccionados por el usuario así como su respectivo precio promedio es caso de existir, de lo contrario el precio asignado será de 0. Se mostrará también el documento de las características de los instrumentos financieros venezolanos, con el fin de que el usuario pueda observar en detalle cada instrumento.
```{r , echo=FALSE, label=img34}
knitr::include_graphics("images/sc1.png")
``` 
3. Luego de esto, se deberá rellenar la información correspondiente a cada metodología como ya se explico en la sección anterior, esto con el fin de obtener todos los parámetros necesarios para calcular los precios teóricos según cada metodología (Ver Imágens siguiente(fig:img35), siguiente(fig:img36), siguiente(fig:img37), siguiente(fig:img38) y siguiente(fig:img39)). 

```{r , echo=FALSE, label=img35}
knitr::include_graphics("images/sc2.png")
``` 
```{r , echo=FALSE, label=img36}
knitr::include_graphics("images/sc3.png")
``` 
```{r , echo=FALSE, label=img37}
knitr::include_graphics("images/sc4.png")
``` 
```{r , echo=FALSE, label=img38}
knitr::include_graphics("images/sc5.png")
``` 
```{r , echo=FALSE, label=img39}
...
``` 
```{r , echo=FALSE, label=img48}
knitr::include_graphics("images/vr6.1.png")
``` 
...
```{r , echo=FALSE, label=img91}
knitr::include_graphics("images/b2.png")
``` 
```{r , echo=FALSE, label=img92}
...
``` 
```{r , echo=FALSE, label=img93}
knitr::include_graphics("images/b4.1.png")
``` 
## Valoración
...
```{r , echo=FALSE, label=img95}
knitr::include_graphics("images/val2.png")
``` 
```{r , echo=FALSE, label=img96}
